...
import us.tlatoani.kosmos.border.event.*;
...
public class BorderMundo {
    ...
    public static void load() {
        ...
        Registration.registerEffect(EffChangeBorderDiameter.class,
                ...
                .document("Change Border Diameter", "1.0", "Changes the diameter, or size, of the specified world's border over the specified timespan.");
        ...
        Registration.registerExpression(ExprPropertyOfBorder.class, Number.class, ExpressionType.PROPERTY,
                ...
                .document("Property of Border", "1.0", "An expression for a certain property of the specified world's border:"
        ...
        MundoPropertyExpression.registerPropertyExpression(ExprCenterOfBorder.class, Location.class, "world", "center")
        ...
        Registration.registerExpressionCondition(CondBeyondBorder.class, ExpressionType.PROPERTY,"%locations% (is|are) (0¦within|1¦beyond) border")
                .document("Is Beyond Border", "1.0", "Checks whether a location/entity is beyond or within the border in its world.");

        loadBorderEvent();
    }

    private static void loadBorderEvent() {
        Bukkit.getWorlds().forEach(BorderMundo::replaceBorderForWorld);
        ...
        Registration.registerEvent("Border Stabilize", EvtBorderStabilize.class, BorderStabilizeEvent.class, "border stabilize [in %-worlds%]")
                .document("Border Stabilize", "1.0", "Called when a border (optionally only of the specified world(s)) stops moving.");
        Registration.registerExpression(ExprBorderMovingValue.class, Number.class, ExpressionType.PROPERTY,
                ...
                .document("Moving Border Diameter", "1.0", "An expression for a certain property of the moving border of the specified world:"
        ...
        Registration.registerExpression(ExprTimeRemainingUntilBorderStabilize.class, Timespan.class, ExpressionType.PROPERTY,
                ...
                .document("Time Remaining Until Border Stabilize", "1.0", "An expression for the timespan remaining until the border of the specified world stops moving.");
        Registration.registerExpressionCondition(CondBorderMoving.class, ExpressionType.PROPERTY, "border of %world% is (0¦moving|1¦stable)", "%world%'s border is (0¦moving|1¦stable)")
                .document("Border is Moving", "1.0", "Checks whether the border of the specified world is moving or stable (not moving).");
    }
    ...
    public static void replaceBorderForWorld(World world) {
        ...
        Logging.debug(BorderMundo.class, "Replaced the border for world: " + world);
    }
